...
allAboutMe.address.street = 'FourFive ave.'
allAboutMe.address.town = 'SevenEight'
allAboutMe.address.state = 'Nine Ten'
...
//the properties should be set the same way I initially set the `codeImmersivesObject` 
//on line 1. It can be called whatever you want and can have whatever properties you 
//want, as long as they include at least one string value, boolean value, number value,
// and array of numbers. The important thing here is: this should all be done within the brackets of the object, 
//not below the place where the object is declared.
const doIKnowYou = {
  iThinkSo: 'lol just kidding',
  butDoI: false,
  howManyJellyBeans: 199,
  myArray: [1,2,3,4,5]
}; 
console.log(doIKnowYou)

// As a stretch goal, go back pre-populate the object with at least one property 
//using a key name that CAN'T be a variable name. That would be anything with a 
//space in it, or a dash, or starting with a number.
